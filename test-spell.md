...
I like dogs, cats and rabbits. To install OpenSearch, do this, this, and this. OpenSearch will return a response or failover in case of errors.
...
Verify the OpenSearch install by running the script. To use fail over systems, do this.
